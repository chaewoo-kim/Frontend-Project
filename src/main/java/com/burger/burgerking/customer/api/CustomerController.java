...
import com.burger.burgerking.customer.dto.Customer;
...
public class CustomerController {
    ...
    @Operation(summary = "문의사항 검색", description = "고객문의 사항 검색 조회")
    @GetMapping("/{content}")
    ...
    @Operation(summary = "대표 문의사항", description = "문의가 많은 질문 5개를 조회하여 제목을 게시 및 Forward링크 설정")
    @GetMapping
    public ResponseEntity<ApiResponse<List<Customer>>> search(){
